...
namespace MedCore_DataAccess.Repository.MongoRepository.Repository
{
    /// <summary>
        ...
        where T : IEntity<TKey>
    {
        ...
        /// <summary>
        /// Upserts the entities with a query.
        /// </summary>
        /// <param name="entities">The entities to update.</param>
        /// <param name="query">The query to update.</param>
        public virtual void UpdateWithQuery(IMongoQuery query, IMongoUpdate entities, bool multi = false)
        {
            if (multi)
                collection.Update(query, entities, UpdateFlags.Multi);
            else
                collection.Update(query, entities);
        }

        /// <summary>
        /// Deletes entities with a query.
        /// </summary>
        /// <param name="query">The query to update.</param>
        ...
        {
            return collection.AsQueryable<T>().Count(predicate);
        }
