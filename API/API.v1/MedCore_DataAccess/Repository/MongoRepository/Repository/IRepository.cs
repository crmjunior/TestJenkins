...
namespace MedCore_DataAccess.Repository.MongoRepository.Repository
{
        ...
        where T : IEntity<TKey>
    {
        ...
        void UpdateWithQuery(IMongoQuery query, IMongoUpdate entities, bool multi = true);
        ...
        /// <summary>
        /// Counts the total entities in the repository matching the predicate.
        /// </summary>
        /// <returns>Count of entities in the repository matching the predicate.</returns>
